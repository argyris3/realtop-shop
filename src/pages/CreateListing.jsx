    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 -y-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center"
            />
          </div>
          <div>
        ...
        <div className='mb-6 '>
          ...
          <p className='text-gray-600'>The first image is will be the cover(max 6)</p>
