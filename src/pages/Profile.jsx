...
import { updateDoc, doc, collection, query, orderBy, getDocs, where, deleteDoc } from 'firebase/firestore';
...
export default function Profile() {
  ...
  async function onDelete(listingID) {
    if (window.confirm('Are you sure you want to delete?')) {
      ...
      const updateListings = listings.filter((listing) => listing.id !== listing.id);
